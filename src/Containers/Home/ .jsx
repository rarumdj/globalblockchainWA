...
function Header() {
  ...
  return (
    <div className=" mt-0 mb-12 mx-0 lg:m-0 py-24 px-8 md:py-24 3xl:min-h-screen md:max-h-screen">
      <div className="container mx-auto flex flex-col md:flex-row">
        <div className="flex flex-1 flex-col justify-center items-start mr-2">
          <motion.h1
            ...
            className="text-white font-extrabold text-4xl lg:text-5xl tracking-wide leading-[40px]">
