...
function HomeFeatures({ title, list, image, link, cName, idn }) {
  ...
  return (
    <motion.div
      ...
      id={idn}>
      <div
        className={`container mx-auto flex pb-2 md:flex-row md:order-last items-center flex-col-reverse ${cName}`}>
